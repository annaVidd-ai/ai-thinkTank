...
const CASES = [
  ...
  // ── Phase 2 Step 4 — Holdout cases (v0.2 validation, LOCKED) ──────────────
  {
    ticker:         'KAS',
    projectAlias:   'Project_HO1',
    sector:         'L1',
    signalDate:     new Date('2022-12-01'),
    signalPrice:    0.0085,
    athPrice:       0.2074,
    actualMultiple: 24.4,
    split:          'verification',
  ...
  {
    ticker:         'TAO',
    projectAlias:   'Project_HO2',
    sector:         'Infrastructure',
    signalDate:     new Date('2023-03-25'),
    signalPrice:    45.00,
    athPrice:       757.60,
    actualMultiple: 16.8,
    split:          'verification',
  ...
  {
    ticker:         'FTM',
    projectAlias:   'Project_HO3',
    sector:         'L1',
    signalDate:     new Date('2021-07-20'),
    signalPrice:    0.28,
    athPrice:       3.48,
    actualMultiple: 12.4,
    split:          'verification',
  ...
  {
    ticker:         'APE',
    projectAlias:   'Project_HO4',
    sector:         'Gaming',
    signalDate:     new Date('2022-04-01'),
    signalPrice:    15.43,
    athPrice:       27.78,
    actualMultiple: 1.8,
    split:          'verification',
  ...
  {
    ticker:         'GLMR',
    projectAlias:   'Project_HO5',
    sector:         'Infrastructure',
    signalDate:     new Date('2022-01-15'),
    signalPrice:    14.50,
    athPrice:       25.65,
    actualMultiple: 1.8,
    split:          'verification',
  ...
  {
    ticker:         'HNT',
    projectAlias:   'Project_HO6',
    sector:         'Infrastructure',
    signalDate:     new Date('2021-11-01'),
    signalPrice:    20.50,
    athPrice:       55.17,
    actualMultiple: 2.7,
    split:          'verification',
